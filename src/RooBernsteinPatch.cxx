...
#include "../interface/RooBernsteinPatch.h"
#include "RooFit.h"
...
ClassImp(RooBernsteinPatch);
 
////////////////////////////////////////////////////////////////////////////////
 
RooBernsteinPatch::RooBernsteinPatch()
{
}
...
RooBernsteinPatch::RooBernsteinPatch(const char* name, const char* title,
  ...
  _coefList("coefficients","List of coefficients",this)
{
  ...
  while((coef = (RooAbsArg*)coefIter->Next())) {
    if (!dynamic_cast<RooAbsReal*>(coef)) {
      cout << "RooBernsteinPatch::ctor(" << GetName() << ") ERROR: coefficient " << coef->GetName()
...
RooBernsteinPatch::RooBernsteinPatch(const RooBernsteinPatch& other, const char* name) :
...
void RooBernsteinPatch::selectNormalizationRange(const char* rangeName, Bool_t force)
{
...
Double_t RooBernsteinPatch::evaluate() const
{
  double xmax,xmin;
...
RooSpan<double> RooBernsteinPatch::evaluateBatch(std::size_t begin, std::size_t batchSize) const {
...
Int_t RooBernsteinPatch::getAnalyticalIntegral(RooArgSet& allVars, RooArgSet& analVars, const char* /*rangeName*/) const
{
...
Double_t RooBernsteinPatch::analyticalIntegral(Int_t code, const char* rangeName) const
{
  R__ASSERT(code==1) ;
